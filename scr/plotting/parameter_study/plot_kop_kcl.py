...
data = pd.read_excel('Rkonst.xlsx', sheet_name='Kop')
...
ax.set_ylabel('$K_{\\mathrm{op}}/K_{\\mathrm{I,max}}$ [MPa]')
ax.set_title('constant $R$=0.0', fontsize=24)
ax.legend(bbox_to_anchor=(1.04, 1.0), loc='upper left',
          title='$K_{\\mathrm{I,max}}$\n[MPa√m]')._legend_box.align = 'left'
savefile = 'r_konst_kop.png'
plt.savefig(savefile, dpi=400)

plt.clf()
fig = plt.figure()
ax = fig.add_subplot(111)
data = pd.read_excel('Rkonst.xlsx', sheet_name='Kcl')
ax.plot(data['t'], data['k15'], marker='x', label='15')
ax.plot(data['t'], data['k20'], marker='x', label='20')
ax.plot(data['t'], data['k25'], marker='x', label='25')
ax.plot(data['t'], data['k30'], marker='x', label='30')
...
ax.set_ylim(0.2, 0.8)
ax.set_xlabel('sheet thickness $t$ [mm]')
ax.set_ylabel('$K_{\\mathrm{cl}}/K_{\\mathrm{I,max}}$ [1]')
ax.set_title('constant $R$=0.0', fontsize=24)
ax.legend(bbox_to_anchor=(1.04, 1.0), loc='upper left',
          title='$K_{\\mathrm{I,max}}$\n[MPa√m]')._legend_box.align = 'left'
savefile = 'r_konst_kcl.png'
plt.savefig(savefile, dpi=400)

data_path = r'Z:\04_Publikationen\2021_IJF_Towards three dimensional aspects of plasticity-induced crack closure\Parameterstudie\Kkonst.xlsx'

plt.clf()
fig = plt.figure()
ax = fig.add_subplot(111)
data = pd.read_excel('Kkonst.xlsx', sheet_name='kop')
...
savefile = 'k_konst_kop.png'
plt.savefig(savefile, dpi=400)

plt.clf()
fig = plt.figure()
ax = fig.add_subplot(111)
data = pd.read_excel('Kkonst.xlsx', sheet_name='kcl')
ax.plot(data['R'], data['t1'], marker='x', label='1')
ax.plot(data['R'], data['t2'], marker='x', label='2')
ax.plot(data['R'], data['t3'], marker='x', label='3')
ax.plot(data['R'], data['t4'], marker='x', label='4')
...
ax.set_title('constant $K_{\\mathrm{I,max}}$=20 MPa√m', fontsize=24)
ax.legend(bbox_to_anchor=(1.04, 1.1), loc='upper left', title='$t$ [mm]')._legend_box.align = 'left'
savefile = 'k_konst_kcl.png'
plt.savefig(savefile, dpi=400)

plt.clf()
fig = plt.figure()
ax = fig.add_subplot(111)
data = pd.read_excel('TKonst.xlsx', sheet_name='Kop')
...
savefile = 't_konst_kop.png'
plt.savefig(savefile, dpi=400)

plt.clf()
fig = plt.figure()
ax = fig.add_subplot(111)
data = pd.read_excel('TKonst.xlsx', sheet_name='Kcl')
ax.plot(data['K'], data['R0'], marker='x', label='0.0')
ax.plot(data['K'], data['R01'], marker='x', label='0.1')
ax.plot(data['K'], data['R02'], marker='x', label='0.2')
ax.plot(data['K'], data['R03'], marker='x', label='0.3')
